...
# Preview
![alt-text](file:///Users/parkerbates/Desktop/Screenshot%202025-11-12%20at%205.46.00%E2%80%AFPM.pdf "Example Execution")
...
# Features
- Generates a csv file titled "phonebook" that stores a contacts name, birthdate, and phone number (can be of infinite length and starts off empty)
- Adds, finds, and deletes specific contacts
- Text-based menu with options to add, delete/clear, find, list, and quit.
